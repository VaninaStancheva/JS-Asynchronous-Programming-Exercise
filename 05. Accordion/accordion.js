async function solution() {
    // take the main container to fill it with elements
    ...
    async function toggle (ev) {
        ...
        const p = accordion.children[0].children[0];
        const extra = accordion.children[0];
    ...
    //custom function which will create accordion template/ overwrite the .createElement method
